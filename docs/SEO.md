...
## 1b. Bản đồ phủ từ khóa — ĐÃ TỐI ƯU Ở ĐÂU (cập nhật 20/07/2026)

| Từ khóa                | Title          | H1/Heading                           | Meta desc | Schema (JSON-LD)                             | Nội dung trang                      |
| ---------------------- | -------------- | ------------------------------------ | --------- | -------------------------------------------- | ----------------------------------- |
| vhd corp / vhdcorp     | ✅ trang chủ   | ✅ chip brand                        | ✅        | ✅ alternateName ["VHD","VHDCorp","vhdcorp"] | ✅ toàn site                        |
| vật tư điện lạnh       | ✅ trang chủ   | ✅ subheading hero + showcase        | ✅        | ✅ knowsAbout                                | ✅ trang chủ, /products, bài viết   |
| vật tư cơ điện (M&E)   | ✅             | ✅ showcase                          | ✅        | ✅ knowsAbout                                | ✅                                  |
| gioăng cao su          | ✅ trang chủ   | ✅ showcase                          | ✅        | ✅ knowsAbout                                | ✅ 4 trang SP + 3 bài blog          |
| gioăng đai treo        | —              | ✅ showcase + H1 trang SP            | ✅        | ✅ Product + knowsAbout                      | ✅ SP + bài "công dụng & cách chọn" |
| gioăng bích / mặt bích | —              | ✅ H1 trang SP                       | ✅        | ✅ Product + knowsAbout                      | ✅ SP + bài "làm kín mặt bích"      |
| tấm cao su             | ✅ (title bài) | ✅ H1 SP + bài                       | ✅        | ✅ Product + knowsAbout                      | ✅ SP + bài "phân loại & ứng dụng"  |
| ống đồng, gas lạnh     | —              | ✅ scene/section                     | ✅        | ✅ knowsAbout                                | ✅ SP + FAQ                         |
| khuôn mẫu đúc nhựa     | ✅ trang chủ   | ✅ H1 hero (slogan khách) → showcase | ✅        | ✅ knowsAbout + Product                      | ✅ SP + bài dịch vụ                 |
| kho tổng / bán sỉ      | —              | ✅ subheading hero                   | ✅        | ✅ Store type + description                  | ✅                                  |

Ghi chú: H1 trang chủ là slogan khách chốt ("NHÀ SẢN XUẤT VÀ CUNG CẤP CHUYÊN NGHIỆP") — từ khóa dồn vào
subheading + title + schema + showcase (Google đọc cả trang, không chỉ H1; không nhồi từ khóa — spam policy).
...
- **HTML đầu có đủ nội dung (SSR)**: trang chi tiết SP/bài truyền initialData từ server → bot AI
  (GPTBot/Claude — không chạy JS) và Googlebot lượt đầu đọc được trọn nội dung. Soft-404 trả HTTP 404 thật.
