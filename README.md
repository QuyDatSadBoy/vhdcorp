...
> 🚀 **Deploy + CI/CD**: [docs/DEPLOY.md](docs/DEPLOY.md) — VPS Ubuntu (Postgres cài thẳng + Kong Gateway + PM2), push `main` là tự build & chạy lại. Có sẵn mục hướng dẫn cho Claude Code agent chạy trên VPS.
