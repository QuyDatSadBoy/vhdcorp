...
async function seedProducts(categories: { id: number; slug: string }[]) {
  const samples = [
    { slug: "ong-nhua-pvc-d21", name: "Ống nhựa PVC D21", price: 25000, stock: 500, categorySlug: "nhua-cao-su" },
    { slug: "tam-cao-su-non", name: "Tấm cao su non chống rung", price: 180000, stock: 120, categorySlug: "nhua-cao-su" },
    { slug: "nuoc-mam-truyen-thong-1l", name: "Nước mắm truyền thống 1L", price: 95000, stock: 300, categorySlug: "thuc-pham-lang-nghe" },
    { slug: "che-thai-nguyen-tan-cuong", name: "Chè Tân Cương Thái Nguyên", price: 220000, stock: 80, categorySlug: "thuc-pham-lang-nghe" },
    { slug: "non-la-lang-chuong", name: "Nón lá làng Chuông", price: 75000, stock: 60, categorySlug: "do-thu-cong" },
    { slug: "tranh-dong-ho", name: "Tranh dân gian Đông Hồ", price: 150000, stock: 40, categorySlug: "do-thu-cong" },
    { slug: "qua-tang-doanh-nghiep", name: "Set quà tặng doanh nghiệp", price: 850000, stock: 20, categorySlug: "san-pham-khac" },
    { slug: "tui-vai-canvas-vhd", name: "Túi vải canvas VHD Corp", price: 65000, stock: 200, categorySlug: "san-pham-khac" },
  ];
  let count = 0;
...
async function seedSiteConfig(adminId: number) {
  const value = {
    brand: {
      ...
      ogDefaultImage: { url: "/images/vhdcorplogo.jpeg", width: 1200, height: 630 },
    },
    theme: {
      colors: {
        primary: "#1B3A8C",
    ...
    navigation: [
      ...
      { id: "nav-products", label: "Sản phẩm", href: "/products", order: 2, children: [] },
      { id: "nav-posts", label: "Tin tức", href: "/posts", order: 3, children: [] },
      { id: "nav-about", label: "Giới thiệu", href: "/about", order: 4, children: [] },
      { id: "nav-contact", label: "Liên hệ", href: "/contact", order: 5, children: [] },
    ],
    footer: {
      columns: [
