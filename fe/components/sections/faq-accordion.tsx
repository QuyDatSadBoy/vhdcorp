  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isOpen ? "border-(--vhd-color-primary)/40 shadow-[0_8px_24px_-16px_rgba(15,35,86,0.2)]" : "border-foreground/8 hover:border-foreground/15",
      )}
    >
      <button
        type="button"
      ...
      >
        <span className="flex items-start gap-4">
          <span className="mt-0.5 grid h-6 min-w-6 shrink-0 place-items-center rounded-full bg-(--vhd-color-primary)/10 text-[11px] font-bold tabular-nums text-brand-primary">
      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        >
          ...
          <h2 className="mt-3 type-display-md text-foreground">
            {p.heading ?? "Mọi điều bạn cần biết về VHD Corp"}
          </h2>
