 ...
 */
export function ImageFallback({ label = "VHD Corp", variant = "product" }: { label?: string; variant?: "product" | "post" | "category" }) {
  ...
  return (
    <div
      aria-hidden
      className={`absolute inset-0 grid place-items-center bg-linear-to-br ${gradient}`}
    >
      ...
      <div className="relative flex flex-col items-center gap-2.5">
        ...
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/30 ring-1 ring-white/40 backdrop-blur-sm">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="stroke-[#1B3A8C]/70">
