  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <Input id="confirm" type="password" autoComplete="new-password" {...form.register("confirm")} aria-invalid={!!form.formState.errors.confirm} />
      ...
      <div className="text-center text-sm">
        <Link href="/login" className="text-brand-primary hover:underline">Đã có tài khoản? Đăng nhập</Link>
      </div>
    </motion.form>
  );
}
