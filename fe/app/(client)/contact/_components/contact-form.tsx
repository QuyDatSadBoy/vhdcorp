...
export default function ContactForm() {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-(--vhd-color-primary) py-20 text-white">
        <div
          aria-hidden
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr]">
          <div className="space-y-4">
            ...
            <p className="text-foreground/65">
              Chọn kênh phù hợp nhất với bạn — chúng tôi luôn sẵn sàng hỗ trợ.
            </p>
                ...
                return (
                  <Wrapper
                    ...
                    {...(it.href
                      ...
                      : {})}
                    className="group flex items-center gap-4 rounded-2xl border border-foreground/8 bg-card p-5 transition-all hover:border-(--vhd-color-primary)/30 hover:shadow-md"
                  >
                    <span className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-(--vhd-color-highlight)/15 text-brand-highlight transition-colors group-hover:bg-(--vhd-color-primary) group-hover:text-white">
          ...
          >
            ...
            <Button
              type="submit"
              disabled={pending}
              className="h-12 w-full rounded-full bg-(--vhd-color-primary) text-base font-semibold text-white shadow-[0_10px_30px_-12px_color-mix(in_srgb,var(--vhd-color-primary)_60%,transparent)] hover:bg-(--vhd-color-primary)/90"
            >
