...
export const zh = {
  ...
  'placeholder.hero': 'Hỏi hoặc giao việc cho trợ lý',
  ...
  'hero.headline': 'Trợ lý nội bộ VHD Corp',
  'hero.preview': 'Nội bộ',
  'hero.author': 'Tác giả: Trần Quý Đạt',
  'hero.chooseWorkspace': 'Chọn thư mục làm việc',
